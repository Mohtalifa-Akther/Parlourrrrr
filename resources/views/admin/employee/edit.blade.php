    ...
    <div class="row">
       <div class="col-md-12">
        <div class="box box-info">
            ...
            <form action="{{ url('/admin/employees/update',$employee) }}" method="post" enctype="multipart/form-data" data-parsley-validate>
                @csrf
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" placeholder="Employee Name" value="{{ $employee->name }}">
                </div>
                    </div>
                    <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Speciality</label>
                  <input type="text" class="form-control" name="speciality" placeholder="Speciality" value="{{ $employee->speciality }}">
                </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="address1" placeholder="Address1" value="{{ $employee->address1 }}">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="address2" placeholder="Address2" value="{{ $employee->address2 }}">
                </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="facebook" placeholder="Facebook" value="{{ $employee->facebook }}">
                </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="twitter" placeholder="Twitter" value="{{ $employee->twitter }}">
                </div>
